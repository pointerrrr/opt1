...
namespace Groot
{
    public class SolutionData
    {
        ...
        void ShiftRandomOrderBetweenTrucks()
        {
            ...
            double oudRijtijd1 = Truck1Rijtijden[dag1];
            double oudRijtijd2 = Truck2Rijtijden[dag2];
            ...
            UpdateRijtijdStraf(oudRijtijd1, Truck1Rijtijden[dag1]);
            UpdateRijtijdStraf(oudRijtijd2, Truck2Rijtijden[dag2]);
        }
        ...
        void UpdateRijtijdStraf(double oud, double nieuw)
        {
            ...
            if (oud >= MinRijtijdDag && nieuw < MinRijtijdDag)
                ...
                SolutionStrafIntern -= (MinRijtijdDag - oud) * RijtijdStrafMinuut + RijtijdStraf;
            else if (oud < MinRijtijdDag && nieuw < MinRijtijdDag)
                SolutionStrafIntern += (oud - nieuw) * RijtijdStrafMinuut;
        }
